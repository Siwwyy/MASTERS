...
#    hyperparams.num_epochs          = 1200

#    # Create Dataset for training and validating
#    train_ds = FullDataset_UE(ds_root_path=Path("F:/MASTERS/UE4/DATASET/"),
#                              ue_projects_list=["SubwaySequencer_4_26_2", "Rainforest_Scene_4_26_2"],
#                              #crop width x height == 128x128 (for now)
#                              crop_coords=(900, 1028, 500, 628), 
#                              cached=False)

#    valid_ds = Dataset_UE(ds_root_path=Path("F:/MASTERS/UE4/DATASET/InfiltratorDemo_4_26_2/DumpedBuffers"),
