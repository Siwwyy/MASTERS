...
def Inference_pipeline(outputs_save_path:PathType=None, model:Model_Base=None, dataset:Dataset_Base=None, device=CurrentDevice):
    ...
    with torch.no_grad():
        ...
        save_exr(str(outputs_save_path/"ldr_pred.exr"), pred_ldr.squeeze(0).cpu().half())
        ...
        print("SSIM between pred hdr and GT hdr: ", ssim(pred_hdr.cpu(), hr_clone.unsqueeze(0).cpu()))
